...
public class LoginDemo {
    public static void main(String[] args) throws Exception {
        ...
        loginDemo.login("chen", "11111");// 输入CSDN的用户名，和密码
    }
    /**
     * 模拟登陆CSDN
     * 
    ...
    public void login(String userName, String pwd) throws Exception {
        ...
        Connection con = Jsoup
                .connect("http://localhost/login.t");// 获取连接
        ...
        datas.put("frcs", rs.cookies().get("__frcs"));
        /**
         * 第二次请求，post表单数据，以及cookie信息
         * 
         * **/
        Connection con2 = Jsoup
                .connect("http://localhost/login_submit.json");
        ...
        /**
         * 第三次请求，post表单数据，以及cookie信息
         * 
         * **/
        Connection con3 = Jsoup
                .connect("http://localhost/index.t");
        con3.header("User-Agent",
                "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:29.0) Gecko/20100101 Firefox/29.0");
        // 设置cookie和post上面的map数据
        Response gbody = con3.ignoreContentType(true).method(Method.GET)
                .cookies(rs.cookies()).execute();
        
        System.out.println(gbody.body());
    }
}
