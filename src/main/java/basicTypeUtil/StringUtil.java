...
public class StringUtil {
	...
	public static void main(String[] args) {
		...
		// 2
		// String cc = r4subs("1111110001");
		// cc = String.valueOf(Integer.parseInt(cc));
	...
	public static String r4subs(String c) {
	 ...
	 * 汉语中数字大写（金额）
	 */
	private final String[] CN_UPPER_NUMBER = { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖" };
	/**
	 * 汉语中货币单位大写，这样的设计类似于占位符
	 */
	private final String[] CN_UPPER_MONETRAY_UNIT = { "分", "角", "元", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰",
			"仟", "兆", "拾", "佰", "仟" };
	/**
	 * 特殊字符：整
	 */
	 ...
	 * @return 对应的汉语大写
	 */
	public String number2CNMontrayUnit(double money) {
