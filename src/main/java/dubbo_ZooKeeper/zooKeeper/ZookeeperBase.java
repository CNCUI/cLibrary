package dubbo_ZooKeeper.zooKeeper;
...
public class ZookeeperBase {
	/** zookeeper地址 */
//	static final String CONNECT_ADDR = "192.168.0.88:2181,192.168.80.87:2181,192.168.80.86:2181";
	static final String CONNECT_ADDR = "192.168.0.102:2181";
	/** session超时时间 */
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(zk.exists("/testRoot", true));
		// 创建父节点
